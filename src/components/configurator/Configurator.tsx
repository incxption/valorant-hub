...
const Configurator: React.FC<Props> = ({ history }) => {
    ...
    return (
        <div className="h-full w-full flex flex-col p-3 tracking-tight">
            ...
            <div className="mx-4 mt-4">
                ...
                <p className="text-sm -mt-1">Select the file in which the Valorant settings are/should be stored.</p>
            ...
            <div className="mx-4 mt-6">
                ...
                <div className="mt-3 flex">
                    ...
                    <Option
                        ...
                        tooltip={
                            selectedFile !== -1 ? "Apply settings from file" : "Not allowed when creating a new file"
                        }
